...
public class Cliente implements Serializable {
	...
	@Column(name="nome") 
	@Size(min=3, max=50, message="O nome deverá conter no mínimo 3 letras para continuar.")
	@Pattern(regexp = "^[A-Z][a-zA-ZáàâãéèêíïóôõöúçñÁÀÂÃÉÈÊÍÏÓÒÖÚÇÑ ]*$", message="O primeiro nome não deve começar com uma letra minúscula, sem número ou caractere especial.")
	private String nome;
