create table produto(id integer auto_increment, nome varchar(50), preço varchar(20), categoria varchar(50), quantidade varchar(250));

create table cliente(id integer auto_increment, nome varchar(50), cpf varchar(18), sexo varchar(15), idade varchar(3));   
